...
class MealTypeController extends Controller
{
    ...
    {
        return view('admin.pages.meal_types.index',compact('type'));
    }

    public function create($type)
    {
        return view('admin.pages.meal_types.create',compact('type'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.meal_types.edit',compact('row'));
    }
...
//            }
//        }
        $row = MealType::whereId($request->row_id)->first();
