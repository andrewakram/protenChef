    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!--begin::Form-->
                <form action="{{route('admin.offers.update')}}" method="post" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" >
                @csrf
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <!--begin::Input-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" type="date" value="{{$row->date}}"  name="date" placeholder="إحتر التاريخ" id="kt_calendar_datepicker_end_date" />                                <!--end::Input-->                                <!--end::Input-->
                                <!--begin::Description-->
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" required name="title_ar" class="form-control mb-2" placeholder="عنوان العرض (بالعربي)" value="{{$row->title_ar}}" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" required name="title_en" class="form-control mb-2" placeholder="عنوان العرض (بالإنجليزي)" value="{{$row->title_en}}" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            {{--                                                <div class="text-muted fs-7">A product name is required and recommended to be unique.</div>--}}
                                            <!--end::Description-->
