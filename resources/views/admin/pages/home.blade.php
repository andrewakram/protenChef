                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-header border-0 py-5">
                                ...
                                <div class="card-toolbar ">
                                    <form id="submit_btn" method="post" action="{{route('homeWzSearch')}}"
                                          style="display: inline-flex">
                                        @csrf

                                        <input class="form-control form-control-solid" type="date" name="date"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <select name="status" required class="form-select mb-2" data-control="select2"
                                        ...
                                        <option></option>
                                        <option value="pending">قيد
                                            التسليم
                                        </option>
                                        <option value="delivered">تم
                                            التسليم
                                        </option>
                                    </select>
                                </div>
