    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.package-meals',[$package_id])}}"
                               class="text-muted text-hover-primary">وجبات الباقات</a>
                        </li>
                        <!--end::Item-->
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!--begin::Form-->
                <form action="{{route('admin.package-meals.store')}}" method="post" enctype="multipart/form-data"
                ...
                <!--begin::Aside column-->
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <!--begin::Select2-->
                                <select name="week" required class="form-select mb-2" data-control="select2"
                                        data-hide-search="true" data-placeholder="إختر الحالة"
                                        id="kt_ecommerce_add_product_status_select">
                                    <option></option>
                                    <option value="1" selected="selected">الاسبوع الاول</option>
                                    <option value="2">الاسبوع الثاني</option>
                                </select>
                                <!--end::Select2-->
                                <!--begin::Description-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <!--begin::Select2-->
                                <select name="day" required class="form-select mb-2" data-control="select2"
                                        data-hide-search="true" data-placeholder="إختر الحالة"
                                        id="kt_ecommerce_add_product_status_select">
                                    <option></option>
                    ...
                    <!--begin:::Tab item-->
                    {{--                            <li class="nav-item">--}}
                    {{--                                <a class="nav-link text-active-warning pb-4 active" data-bs-toggle="tab" href="#kt_ecommerce_add_product_general">بيانات الوجبة للباقة</a>--}}
                    {{--                            </li>--}}
                    <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                    {{--                            <li class="nav-item">--}}
                    ...
                    <!--end:::Tabs-->
                                                                ...
                                                                <div class="col-lg-6 col-md-6">
                                                                    ...
                                                                    <select class="form-select mb-2" name="package_id"
                                                                        ...
                                                                        @foreach($packages as $key => $package)
                                                                            <option
                                                                                value="{{$package->id}}" {{$key==0 ? 'selected' : ''}}>{{$package->title_ar}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    <!--end::Select2-->
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-6">
                                                                    ...
                                                                    <select name="meal_id" required
                                                                            class="meal_id form-select mb-2"
                                                                            data-control="select2" data-hide-search="false"
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{route('admin.package-meals',[$package_id])}}"
                               id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">عودة</a>
                            <!--end::Button-->
                            <!--begin::Button-->
