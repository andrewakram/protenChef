        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">الرئيسية
                        <!--begin::Separator-->
                        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class=" fs-3 fw-bold my-1 ms-1" style="color: #F48120">أنواع الباقات</small>
                        <!--end::Description-->
                    </h1>
                    <!--end::Title-->
                </div>
...
{{--                    </div>--}}
                    <!--end::Wrapper-->
                    <!--begin::Button-->
{{--                    <a href="{{route('admin.package-types.create')}}" class="btn btn-sm btn-success"--}}
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#slider_table").DataTable({
                ...
                ajax: '{{ route('admin.package-types.datatable') }}',
                "columns": [
        ...
        $(document).on("click", ".delete", function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '{{route('admin.package-types.delete')}}',
                        type: "post",
