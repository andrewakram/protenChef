    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <!--end::Wrapper-->
                    <!--begin::Button-->
                                    <a href="{{route('admin.package-types.create',[$packageType->id])}}" class="btn btn-sm btn-success"
                                        data-bs-target="#kt_modal_create_app" id=""
                                    >
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#slider_table").DataTable({
                    ...
                    },
                    {
                        ...
                        customize: function (win) {
                            $(win.document.body)
                                ...
                                '                                    <td style="text-align: right"><p>عنوان التقرير : أنواع الباقات</p>' +
                ...
                ajax: '{{ route('admin.package-types.datatable-details',[$packageType->id]) }}',
                "columns": [
