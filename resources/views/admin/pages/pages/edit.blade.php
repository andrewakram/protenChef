            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            @if($type == 'about')
                                <a href="{{route('admin.pages.edit',['about'])}}" class="text-muted text-hover-primary">
                                    صفحة عن التطبيق
                                </a>
                            @elseif($type == 'terms')
                                <a href="{{route('admin.pages.edit',['terms'])}}" class="text-muted text-hover-primary">
                                    صفحة الشروط والاحكام
                                </a>

                            @elseif($type == 'frozen')
                                <a href="{{route('admin.pages.edit',['frozen'])}}" class="text-muted text-hover-primary">
                                    صفحة سياسة التجميد
                                </a>
                            @endif
                        </li>
