    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!--begin::Form-->
                <form action="{{route('admin.package-type-prices.store')}}" method="post" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" >
                    @csrf
                    <!--begin::Aside column-->
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <!--begin::Select2-->
                                <input type="number" required name="price" class="form-control mb-2" placeholder="سعر الباقة" value="" />
                                <!--end::Select2-->
                                <!--begin::Description-->
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <select class="form-select mb-2" name="package_id" data-control="select2" data-hide-search="false" data-placeholder="إختر الباقة">
                                                                ...
                                                                @foreach($packages as $key => $package)
                                                                    <option value="{{$package->id}}" {{$key==0 ? 'selected' : ''}}>{{$package->title_ar}}</option>
                                                                @endforeach
                                                            </select>
                                                            <!--end::Select2-->
                                                        </div>
