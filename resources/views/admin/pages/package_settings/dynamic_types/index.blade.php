        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center py-1">
                    <a href="{{route('admin.package_types_settings.dynamic_types.create')}}" class="btn btn-sm btn-success">
                        <i class="fa fa-plus"></i>أضف
                    </a>
                </div>
                <!--end::Actions-->
            </div>
    ...
    <script>
        $(document).ready(function () {
            $("#slider_table").DataTable({
                ...
                ajax: '{{ route('admin.package_types_settings.dynamic_types.datatable') }}',
                "columns": [
